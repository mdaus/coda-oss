...
class FileHandler(StreamHandler):
    ...
    def __init__(self, *args):
        """
        __init__(logging::FileHandler self, std::filesystem::path const & fname, LogLevel level, int creationFlags) -> FileHandler
        __init__(logging::FileHandler self, std::filesystem::path const & fname, LogLevel level) -> FileHandler
        __init__(logging::FileHandler self, std::filesystem::path const & fname) -> FileHandler
        """

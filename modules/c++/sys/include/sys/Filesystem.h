...
struct path
{
    ...
    path& operator/=(
            const path&
                    p);  // http://en.cppreference.com/w/cpp/filesystem/path/append
    path& operator/=(
            const value_type*
                    p);  // http://en.cppreference.com/w/cpp/filesystem/path/append
    path& operator/=(
...
bool operator==(
        const path& lhs,
        const path&
                rhs) noexcept;  // https://en.cppreference.com/w/cpp/filesystem/path/operator_cmp
bool operator!=(
        const path& lhs,
        const path&
                rhs) noexcept;  // https://en.cppreference.com/w/cpp/filesystem/path/operator_cmp
...
path absolute(
        const path&);  // http://en.cppreference.com/w/cpp/filesystem/absolute

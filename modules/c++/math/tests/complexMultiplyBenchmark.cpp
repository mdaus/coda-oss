 ...
 */
void getMultWComplex(sys::RealTimeStopWatch &wtch, const std::vector<std::complex<float>> &in, size_t sze,
 ...
 *      return value: The mean of the vector
 */
void getMultWDouble(sys::RealTimeStopWatch &wtch, const std::vector<std::complex<float>> &in, size_t sze,
                    double &duration, size_t numLoops = 1)
{
...
{
    out << std::setw(15) << sze << std::setw(15) << durOne / 1000 << std::setw(25) << durTwo / 1000 << std::endl;
}

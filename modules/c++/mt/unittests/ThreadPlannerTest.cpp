...
TEST_CASE("GetThreadInfoTest")
{
    ...
    for (size_t ii = 0; ii < numThreads; ++ii)
    {
        ...
        if (ii == numThreads - 1)
        {
            CHECK(numElements == static_cast<size_t>(20));
        }
        else
        {
            CHECK(numElements == static_cast<size_t>(32));
        }
    }
}

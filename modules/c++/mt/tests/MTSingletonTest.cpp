...
class Brutus : public Thespian
{
  public:
    ...
    virtual void doLines() override
    {
        ...
        // than his. If then that friend demand   why Brutus rose against Caesar, this is my answer:   --Not that I
        // loved Caesar less, but that I loved   Rome more. Had you rather Caesar were living and 25  die all slaves,
        // than that Caesar were dead, to live   all free men? As Caesar loved me, I weep for him;   as he was
        // fortunate, I rejoice at it; as he was   valiant, I honour him: but, as he was ambitious, I   slew him. There
        // is tears for his love; joy for his 30  fortune; honour for his valour; and death for his   ambition. Who is
        // here so base that would be a   bondman? If any, speak; for him have I offended.   Who is here so rude that
        // would not be a Roman? If any, speak; for him have I offended. Who is here so 35  vile that will not love his
...
class Antony : public Thespian
{
  public:
    ...
    void doLines() override
    {
        ...
        // show'd your teeth like apes, and fawn'd like hounds, 45  And bow'd like bondmen, kissing Caesar's feet;
        // Whilst damned Casca, like a cur, behind   Struck Caesar on the neck. O you flatterers!");
    }
};

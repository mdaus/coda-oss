...
#if _MSC_VER
#pragma warning(disable : 5039) // '...': pointer or reference to potentially throwing function passed to '...' function
                                // under -EHc. Undefined behavior may occur if this function throws an exception.
#endif
...
template <typename T, bool AutoDestroy = false> class Singleton
{
  public:
    /*!
...
template <typename T, bool AutoDestroy> void Singleton<T, AutoDestroy>::destroy()
{
    // double-checked locking
    if (mInstance != nullptr)
    {

...
ZipEntry *ZipFile::newCentralDirEntry(sys::ubyte **buf, sys::SSize_T len)
{
    ...
    *buf = p;
    ...
    return new ZipEntry(mCompressed + dataOffset, compressedSize, uncompressedSize, fileName, fileComment,
                        versionMadeBy, versionToExtract, generalPurposeBitFlag, compressionMethod, lastModifiedTime,
                        lastModifiedDate, crc32, internalAttrs, externalAttrs);
}

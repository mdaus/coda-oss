...
CODA_OSS_API coda_oss::u8string u8FromNative(const std::string&); // platform determines Windows-1252 or UTF-8 input
...
CODA_OSS_API coda_oss::u8string u8FromNative(const std::wstring&); // platform determines UTF16 or UTF-32 input

...
template <typename T1> inline auto Format(const char *format, const T1 &t1)
{
    return Format_(format, t1);
}
template <typename T1, typename T2> inline auto Format(const char *format, const T1 &t1, const T2 &t2)
{
...
inline auto Format(const char *format, const char *pStr1, const std::string &s2, const char *pStr3,
                   const std::string &s4)
{

...
static const auto &Windows1252_x80_x9F_to_u8string_()
{
    static const std::map<char32_t, coda_oss::u8string> retval{
        ...
        ,
        {U'\x81', utf8_(U'\x0081')} // UNDEFINED; _bstr_t just preserves these values, do the same  // , {U'\x81',
        ...
        ,
        {U'\x8D', utf8_(U'\x008D')} // UNDEFINED; _bstr_t just preserves these values, do the same  // , {U'\x8D',
                                    // replacement_character } // UNDEFINED
        ,
        {U'\x8E', utf8_(U'\x017D')} // LATIN CAPITAL LETTER Z WITH CARON
        ,
        {U'\x8F', utf8_(U'\x008F')} // UNDEFINED; _bstr_t just preserves these values, do the same  // , {U'\x8F',
                                    // replacement_character } // UNDEFINED
        ,
        {U'\x90', utf8_(U'\x0090')} // UNDEFINED; _bstr_t just preserves these values, do the same  // , {U'\x90',
                                    // replacement_character } // UNDEFINED
        ,
        ...
        ,
        {U'\x9D', utf8_(U'\x009D')} // UNDEFINED; _bstr_t just preserves these values, do the same  // , {U'\x9D',
                                    // replacement_character } // UNDEFINED
        ,
...
template <typename CharT> inline void append(std::basic_string<CharT> &result, const coda_oss::u8string &utf8)
{
...
template <typename TChar> class Windows1252_to_basic_string final
{
...
static void get_next_utf8_byte(coda_oss::u8string::const_pointer p, size_t sz, size_t &i, coda_oss::u8string &utf8)
{
    if (!(i + 1 < sz))
    {
...
template <typename TBasicStringT, typename CharT> inline auto to_uXXstring(const std::basic_string<CharT> &s)
{
...
template <typename CharT, bool is_utf8> struct basic_string_to_uXXstring_ final
{
};
template <typename CharT> struct basic_string_to_uXXstring_<CharT, true /*is_utf8*/> final
{
...
template <typename CharT> struct basic_string_to_uXXstring_<CharT, false /*is_utf8*/> final
{
    auto operator()(const std::basic_string<CharT> &s) const
    {
...
template <bool is_utf8, typename CharT> inline auto to_wstring_(const std::basic_string<CharT> &s)
{

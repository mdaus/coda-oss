...
static bool utf_to_1252_(const TMap& map, const TUtf& utf, std::basic_string<TChar>& result, bool strict)
{
...
static void utf16to1252_(std::u16string::value_type utf, std::string& result, bool strict)
{

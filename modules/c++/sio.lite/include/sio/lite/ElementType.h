...
template <> struct ElementType<sys::Int8_T>
{
    static const size_t Type = sio::lite::FileHeader::SIGNED;
};
template <> struct ElementType<sys::Int16_T>
{
    static const size_t Type = sio::lite::FileHeader::SIGNED;
};
template <> struct ElementType<sys::Int32_T>
{
    static const size_t Type = sio::lite::FileHeader::SIGNED;
};
template <> struct ElementType<sys::Int64_T>
{
    static const size_t Type = sio::lite::FileHeader::SIGNED;
};
...
template <> struct ElementType<double>
{
    static const size_t Type = sio::lite::FileHeader::FLOAT;
};
template <> struct ElementType<std::complex<float>>
{
    static const size_t Type = sio::lite::FileHeader::COMPLEX_FLOAT;
};
template <> struct ElementType<std::complex<double>>
{
    static const size_t Type = sio::lite::FileHeader::COMPLEX_FLOAT;
};
} // namespace lite

...
TEST_CASE(testInvert2x2)
{
    ...
    double q[] = {-0.326773864841957, 0.945102555946311, 0.945102555946311, 0.326773864841957};
    double correct[] = {-0.326773864841957, 0.945102555946311, 0.945102555946311, 0.326773864841957};
    Matrix2x2 Q(q);
...
TEST_CASE(testInvert3x3)
{
    ...
    double q[] = {-0.8335, -0.3467, 0.4302, 0.5354, -0.3149, 0.7837, -0.1362, 0.8835, 0.4481};

    double correct[] = {-0.833535710413543, 0.535408997517066,  -0.136218298488716,
...
TEST_CASE(testInvert4x4)
{
    ...
    double q[] = {0.537004, -0.291456, -0.769743, 0.184864, 0.377207, 0.812143,  -0.145395, -0.420713,
                  0.678185, 0.025277,  0.573694,  0.458585, 0.330765, -0.504816, 0.239229,  -0.760608};
    double qinv[] = {0.537004,  0.377207, 0.678185, 0.330765, -0.291456, 0.812143, 0.025277, -0.504816, -0.769743,
                     -0.145395, 0.573694, 0.239229, 0.184864, -0.420713, 0.458585, -0.760608
    ...
    double m[] = {9, 7.34847, 7.34847, 6, 7.34847, 9, 6, 7.34847, 7.34847, 6, 9, 7.34847, 6, 7.34847, 7.34847, 9};
    double minv[] = {1.0000,  -0.8165, -0.8165, 0.6667,  -0.8165, 1.0000,  0.6667,  -0.8165,
                     -0.8165, 0.6667,  1.0000,  -0.8165, 0.6667,  -0.8165, -0.8165, 1.0000};
    MatrixMxN<4, 4> M(m);
...
TEST_CASE(testOrthoTranspose5x5)
{
    ...
    double q[] = {0.206598102328096,  -0.258732861775711, -0.366144101439697, 0.808267284061313,  0.320962653355259,
...
TEST_CASE(testInvert5x5)
{
    ...
    double q[] = {-0.1, -0.0, 0.6, -0.3, 0.6,  -0.2, 0.6,  -0.1, 0.5,  0.4,  -0.9, 0.0, 0.0,
                  -0.2, -0.3, 0.3, 0.7,  -0.0, -0.5, -0.1, -0.0, -0.2, -0.7, -0.3, 0.4};

    double correct[] = {-0.165907, -0.304698, -0.947308, 0.232976,  -0.098678, -0.115846, 0.667319,
                        0.131571,  0.800976,  -0.194628, 0.654964,  -0.199442, -0.051345, -0.068673,
                        -0.838682, -0.416854, 0.656088,  -0.329889, -0.691226, -0.451030, 0.775624,
                        0.476702,  -0.271485, -0.238111, 0.596720};
    Matrix5x5 Q(q);
...
TEST_MAIN(TEST_CHECK(testIdentityMxN); TEST_CHECK(testScaleMultiplyMxN); TEST_CHECK(testSetRows);
          TEST_CHECK(testGrabRows); TEST_CHECK(testSetCols); TEST_CHECK(testGrabCols); TEST_CHECK(testArithmeticMxN);
          TEST_CHECK(testPermuteInvert2x2); TEST_CHECK(testInvert2x2Complex); TEST_CHECK(testInvert2x2);
          TEST_CHECK(testInvert3x3); TEST_CHECK(testInvert4x4); TEST_CHECK(testInvert5x5); TEST_CHECK(testPtrAssign);
          TEST_CHECK(testSTLVectorAssign); TEST_CHECK(testOrthoTranspose5x5); TEST_CHECK(testNegateMxN);

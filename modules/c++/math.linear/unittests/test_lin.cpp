...
TEST_CASE("testEmptyDim")
{
    ...
    SUCCEED(); // need to use hidden "testName" parameter
}
...
TEST_CASE("testNormalize")
{
    ...
    CHECK_THAT(v1[0], Catch::Matchers::WithinRel(truth[0], 0.0001L));
    CHECK_THAT(v1[1], Catch::Matchers::WithinRel(truth[1], 0.0001L));
    CHECK_THAT(v1[2], Catch::Matchers::WithinRel(truth[2], 0.0001L));
}

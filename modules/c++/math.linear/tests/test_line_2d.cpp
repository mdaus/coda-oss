...
TEST_CASE("testVertical")
{
    ...
    CHECK_THROWS(vertLine.intersection(vertLine2));
    ...
    CHECK(actual1.row == expected1.row);
    CHECK(actual1.col == expected1.col);
    ...
    CHECK(actual2.row == expected2.row);
    CHECK(actual2.col == expected2.col);
    ...
    CHECK(pActual1.row == pExpected1.row);
    CHECK(pActual1.col == pExpected1.col);
    ...
    CHECK(pActual2.row == pExpected2.row);
    CHECK(pActual2.col == pExpected2.col);
    ...
    CHECK(pActual3.row == pExpected3.row);
    CHECK(pActual3.col == pExpected3.col);
    ...
    CHECK(pActual4.row == pExpected4.row);
    CHECK(pActual4.col == pExpected4.col);
    ...
    CHECK(pActual5.row == pExpected5.row);
    CHECK(pActual5.col == pExpected5.col);
    ...
    CHECK(pActual6.row == pExpected6.row);
    CHECK(pActual6.col == pExpected6.col);
...
TEST_CASE("testHorizontal")
{
    ...
    CHECK_THROWS(horiLine.intersection(horiLine2));
    ...
    CHECK_THROWS(horiLine.intersection(horiLine.parallelToLine(P1)));
    CHECK_THROWS(horiLine.intersection(horiLine.parallelToLine(P2)));
    CHECK_THROWS(horiLine.intersection(horiLine.parallelToLine(P3)));
    CHECK_THROWS(horiLine.intersection(horiLine.parallelToLine(P4)));
    CHECK_THROWS(horiLine.intersection(horiLine.parallelToLine(P5)));
    CHECK_THROWS(horiLine.intersection(horiLine.parallelToLine(P6)));
...
TEST_CASE("testNormal")
{
    ...
    CHECK(actualXIntercept == expectedXIntercept);
    ...
    CHECK_THROWS(normLine.intersection(normLine));
    ...
    CHECK(actualIntersection.row == expectedRow);
    CHECK(actualIntersection.col == expectedCol);
    ...
    CHECK(actualIntersection2.row == expectedRow2);
    CHECK(actualIntersection2.col == expectedCol2);
    ...
    CHECK(actualIntersection3.row == expectedRow3);
    CHECK(actualIntersection3.col == expectedCol3);
    ...
    CHECK_THROWS(normLine.intersection(L1));
    CHECK_THROWS(normLine.intersection(L2));
    CHECK_THROWS(normLine.intersection(L3));
    CHECK_THROWS(normLine.intersection(L4));
    ...
    CHECK_THROWS(pL1.intersection(rPL1));
    CHECK_THROWS(pL2.intersection(rPL2));
    CHECK_THROWS(pL3.intersection(rPL3));
    CHECK_THROWS(pL4.intersection(rPL4));

    // 9. testing distanceToPoint
    CHECK(normLine.distanceToPoint(P1) == expectedDistToPt(normLine, P1));
    CHECK(normLine.distanceToPoint(P2) == expectedDistToPt(normLine, P2));
    CHECK(normLine.distanceToPoint(P3) == expectedDistToPt(normLine, P3));
    CHECK(normLine.distanceToPoint(P4) == expectedDistToPt(normLine, P4));
    ...
    for (size_t i = 0; i < 100; ++i, m += 0.1)
    {
        ...
        CHECK(actualO.row == expectedO.row);
        CHECK(actualO.col == expectedO.col);
    }
    // P2
    m = 0;
    for (size_t i = 0; i < 100; ++i, m += 0.1)

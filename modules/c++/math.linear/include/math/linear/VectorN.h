...
template <typename _T> VectorN<3, _T> cross(const VectorN<3, _T> &u, const VectorN<3, _T> &v)
{
    VectorN<3, _T> xp;
...
template <size_t _ND, typename _T> VectorN<_ND, _T> constantVector(_T cv = 0)
{
...
template <size_t _MD, size_t _ND, typename _T>
math::linear::VectorN<_ND, _T> operator*(const math::linear::VectorN<_MD, _T> &v,
...
template <size_t _ND, typename _T> std::ostream &operator<<(std::ostream &os, const math::linear::VectorN<_ND, _T> &v)
{

...
template <typename T, instruction_set>
constexpr size_t Elements_per_vector();
...
inline size_t Elements_per_vector()
{
    if (isAVX512())
    {
        return Elements_per_vector<T, instruction_set::AVX512>();
    }
    if (isAVX())
    {
        return Elements_per_vector<T, instruction_set::AVX>();
    }
    if (isSSE2())
    {
        return Elements_per_vector<T, instruction_set::SSE2>();
    }

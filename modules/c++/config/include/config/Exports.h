...
// from a DLL simpler. All files within this DLL are compiled with the CODA_OSS_LIBRARY_EXPORTS
// symbol defined on the command line. This symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// CODA_OSS_LIBRARY_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
// https://www.gnu.org/software/gnulib/manual/html_node/Exported-Symbols-of-Shared-Libraries.html
#ifdef CODA_OSS_LIBRARY_EXPORTS
    #define CODA_OSS_LIBRARY_API CODA_OSS_library_export
#else
    ...
    // The default is a static LIB as that's what existing code/builds expect.
        ...
        // destructors) correct.
        #define CODA_OSS_LIBRARY_API CODA_OSS_library_import
    #else

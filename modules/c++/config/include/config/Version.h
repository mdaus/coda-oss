...
#define CODA_OSS_MAKE_VERSION_MMPB(major, minor, patch, build)                                                         \
    (major * CODA_OSS_VERSION_major_) + (minor * CODA_OSS_VERSION_minor_) + (patch * CODA_OSS_VERSION_patch_) + build
...
#define CODA_OSS_VERSION                                                                                               \
    CODA_OSS_MAKE_VERSION_MMPB(CODA_OSS_VERSION_MAJOR, CODA_OSS_VERSION_MINOR, CODA_OSS_VERSION_PATCH,                 \
                               CODA_OSS_VERSION_BUILD)

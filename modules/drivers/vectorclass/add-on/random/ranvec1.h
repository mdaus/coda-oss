...
******************************************************************************/
// physicalSeedType: Determine the type of physical seed that can be generated
// by current CPU. Return value:
// 0:  No physical seed
...
// physicalSeed(): Get a non-reproducible random number based on a physical 
// process. The source of randomness is indicated by physicalSeedType();
int physicalSeed();


/******************************************************************************
        Ranvec1base: Base class for combined pseudo random number generator
...
protected:
    ...
    // constant tables
    static const uint32_t TransformationMat[16]; // Transformation matrix for MTGP
    static const uint32_t TemperingMat[16];      // Tempering matrix for MTGP
    static const uint32_t MWCFactors[16];        // Factor for MWC
};
